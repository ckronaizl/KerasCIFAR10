...
@author: Morgan Dickinson, Cody Kronaizl
...
#batch size 54
#Train model
history = model.fit(X_train, y_train, validation_data=(X_test, y_test), epochs=30, batch_size=54)
history2 = model.fit(X_train, y_train, validation_data=(X_test, y_test), epochs=40, batch_size=54)
history3 = model.fit(X_train, y_train, validation_data=(X_test, y_test), epochs=50, batch_size=54)
history4 = model.fit(X_train, y_train, validation_data=(X_test, y_test), epochs=60, batch_size=54)
...
plt.plot(history.history4['accuracy'])
plt.show()


#Predicted image label
#prediction = np.argmax(model.predict(sample.reshape(-1, *sample.shape))[0])
